...
export const services: Service[] = [
  ...
  },
  {
    ...
    shortDescription:
      "Surgical sperm retrieval at Joshi's Andrology and Urology Hospital, Sahakar Nagar — PESA, TESA, TESE, and micro-TESE for men with azoospermia, planned alongside IVF / ICSI.",
    longDescription: [
      "When sperm is not available in the ejaculate (azoospermia) or in very low numbers, sperm can often be retrieved directly from the epididymis or testis using a small surgical procedure. At Joshi's Andrology and Urology Hospital, we offer the full range of sperm retrieval treatments in Bangalore — PESA, TESA, TESE, and micro-TESE — planned alongside IVF / ICSI for the best chance of pregnancy.",
      "Each technique is selected based on the cause of azoospermia, hormonal profile, scrotal examination, and prior fertility history. Our team coordinates the retrieval with your IVF cycle, so retrieved sperm can be used fresh or frozen for future use.",
      "Procedures are performed under local or short anaesthesia as day-care surgery, with focus on patient safety, minimal discomfort, and confidentiality.",
    ],
    symptoms: [
      "Azoospermia (no sperm in semen analysis)",
      "Very low sperm count (severe oligospermia)",
      "Prior failed IVF / ICSI due to male factor",
      "Post-vasectomy fertility planning",
      "Obstructive or non-obstructive azoospermia",
    ],
    treatments: [
      { name: "PESA", description: "Percutaneous Epididymal Sperm Aspiration — needle aspiration from the epididymis for obstructive azoospermia." },
      { name: "TESA", description: "Testicular Sperm Aspiration — needle aspiration of sperm directly from the testis." },
      { name: "TESE", description: "Testicular Sperm Extraction — small tissue biopsy from the testis to recover sperm." },
      { name: "micro-TESE", description: "Microsurgical sperm extraction under an operating microscope for non-obstructive azoospermia." },
      { name: "Coordinated IVF / ICSI", description: "Retrieved sperm used fresh or frozen with our IVF / ICSI programme for best outcomes." },
    ],
    whyChooseUs: [
      "Full range of sperm retrieval techniques under one roof",
      "Experienced andrology team led by Dr. Praveen Joshi",
      "Coordinated with onsite IVF / ICSI cycle planning",
      "Day-care procedures with local / short anaesthesia",
      "Trusted Sahakar Nagar, Bangalore location",
      "Complete privacy and supportive counselling",
    ],
    faqs: [
      { q: "Who needs sperm retrieval?", a: "Men with azoospermia (no sperm in the ejaculate), severe oligospermia, prior failed ejaculation-based IVF, or post-vasectomy fertility plans. The right technique is decided after evaluation." },
      { q: "Is the procedure painful?", a: "Procedures are done under local or short general anaesthesia, with minimal discomfort. Most patients return home the same day." },
      { q: "Can retrieved sperm be frozen?", a: "Yes — retrieved sperm can be used fresh with an IVF / ICSI cycle or frozen for future use, depending on your treatment plan." },
    ],
    icon: "M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3",
    accent: "gold",
  },
  {
    ...
    shortDescription:
      "Percutaneous Epididymal Sperm Aspiration (PESA) at Joshi's Andrology and Urology Hospital, Sahakar Nagar — minimally invasive sperm retrieval for obstructive azoospermia, paired with IVF / ICSI.",
    longDescription: [
      "Percutaneous Epididymal Sperm Aspiration (PESA) is a minimally invasive sperm retrieval technique used when sperm is being produced but cannot pass through the reproductive tract — most commonly in obstructive azoospermia, post-vasectomy cases, or congenital absence of the vas deferens.",
      "At Joshi's Andrology and Urology Hospital in Bangalore, PESA is performed as a quick day-care procedure under local or short anaesthesia. A fine needle is used to aspirate sperm directly from the epididymis, which is then used fresh for ICSI or frozen for future cycles.",
      "Because there are no surgical incisions, recovery is fast and most patients return to normal activity within a day. Our team coordinates PESA with your IVF / ICSI programme to maximise the chance of pregnancy.",
    ],
    symptoms: [
      "Obstructive azoospermia",
      "Prior vasectomy with current pregnancy plans",
      "Congenital absence of the vas deferens (CBAVD)",
      "Blocked reproductive tract on evaluation",
      "Planned ICSI cycle requiring surgical sperm",
    ],
    treatments: [
      { name: "PESA Procedure", description: "Fine-needle aspiration of sperm from the epididymis under local or short anaesthesia." },
      { name: "Sperm Preparation for ICSI", description: "Onsite andrology lab processes aspirated sperm for fresh use in ICSI." },
      { name: "Sperm Freezing", description: "Retrieved sperm can be frozen for future IVF / ICSI cycles." },
      { name: "Coordinated ICSI", description: "PESA timed with your partner's egg retrieval for fresh-cycle ICSI." },
    ],
    whyChooseUs: [
      "Experienced andrology team with high PESA success rates",
      "Minimally invasive — no surgical incision, fast recovery",
      "Onsite WHO-standard andrology lab for sperm processing",
      "Coordinated with IVF / ICSI cycle planning",
      "Day-care procedure with local / short anaesthesia",
      "Trusted Sahakar Nagar, Bangalore location",
    ],
    faqs: [
      { q: "Who is PESA suitable for?", a: "PESA is ideal for men with obstructive azoospermia, post-vasectomy fertility plans, or congenital absence of the vas — where sperm production is normal but blocked from the ejaculate." },
      { q: "How long does PESA take?", a: "The procedure itself usually takes 20-30 minutes. Most patients are discharged the same day and can resume normal activity within 24 hours." },
      { q: "What if no sperm is found with PESA?", a: "If PESA does not yield enough sperm, we can convert to TESA, TESE, or micro-TESE during the same session, depending on the underlying cause." },
    ],
  ...
  },
  {
    ...
    shortDescription:
      "Testicular Sperm Aspiration (TESA) at Joshi's Andrology and Urology Hospital, Sahakar Nagar — surgical sperm retrieval for azoospermia, planned alongside IVF / ICSI for the best chance of pregnancy.",
    longDescription: [
      "Testicular Sperm Aspiration (TESA) is a surgical sperm retrieval procedure where sperm is collected directly from the testicular tissue using a fine needle. It is commonly used in men with azoospermia where PESA is not suitable or unsuccessful — including some non-obstructive cases.",
      "At Joshi's Andrology and Urology Hospital in Bangalore, TESA is performed as a day-care procedure under local or short anaesthesia. The retrieved sperm is processed onsite by our WHO-standard andrology lab and used fresh for ICSI or frozen for later use.",
      "Our andrology team selects TESA, micro-TESE, or other retrieval methods based on hormone profile, scrotal examination, and prior fertility evaluation — coordinated closely with your IVF / ICSI cycle.",
    ],
    symptoms: [
      "Azoospermia (obstructive or non-obstructive)",
      "Severe oligospermia",
      "Failed PESA retrieval",
      "Prior failed IVF / ICSI due to male factor",
      "Planned ICSI cycle requiring surgical sperm",
    ],
    treatments: [
      { name: "TESA Procedure", description: "Fine-needle aspiration of sperm directly from the testis under local or short anaesthesia." },
      { name: "Sperm Preparation for ICSI", description: "Onsite andrology lab processes the retrieved sperm for ICSI." },
      { name: "Sperm Freezing", description: "Retrieved sperm can be frozen for use in future IVF / ICSI cycles." },
      { name: "Escalation to micro-TESE", description: "If TESA yields insufficient sperm, we can proceed with micro-TESE in the same setting." },
    ],
    whyChooseUs: [
      "Full range of sperm retrieval options — TESA, TESE, micro-TESE",
      "Experienced andrology team led by Dr. Praveen Joshi",
      "Onsite WHO-standard andrology lab for sperm processing",
      "Coordinated with IVF / ICSI cycle planning",
      "Day-care procedure with local / short anaesthesia",
    ...
    faqs: [
      { q: "How is TESA different from PESA?", a: "PESA aspirates sperm from the epididymis (used in obstructive azoospermia). TESA aspirates sperm directly from the testis — useful when PESA isn't suitable or has failed." },
      { q: "Is TESA done under general anaesthesia?", a: "Most TESA procedures are done under local anaesthesia with sedation. Short general anaesthesia may be used depending on patient comfort and clinical factors." },
      { q: "What happens if TESA does not find sperm?", a: "In selected cases we can convert to micro-TESE during the same session — a microsurgical technique that improves sperm recovery in non-obstructive azoospermia." },
    ],
    icon: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z",
    accent: "gold",
  },
