...
export const services: Service[] = [
  ...
  },
  {
    ...
    longDescription: [
      "Facing challenges in conceiving due to low sperm count or azoospermia? At Joshi Andrology and Urology Centre, we provide advanced Sperm Retrieval Treatment in Bangalore to help men achieve their dream of fatherhood. Our specialised andrology team offers state-of-the-art diagnostic and treatment solutions for male infertility, including advanced surgical sperm retrieval procedures for men with obstructive and non-obstructive azoospermia.",
      "As a leading andrology hospital in Bangalore, we focus on personalised fertility care using evidence-based techniques and advanced microsurgical procedures.",
      "Surgical Sperm Retrieval (SSR) refers to specialised procedures used to obtain sperm directly from the epididymis or testicles when sperm are absent in the ejaculate. These techniques are particularly beneficial for men diagnosed with azoospermia, a condition where no sperm are found in the semen. Retrieved sperm can often be used for assisted reproductive techniques such as IVF (In Vitro Fertilisation) and ICSI (Intracytoplasmic Sperm Injection), improving the chances of successful conception.",
      "Azoospermia affects a significant number of infertile men and may occur due to blockages in the reproductive tract (obstructive azoospermia), reduced or impaired sperm production (non-obstructive azoospermia), previous infections or surgeries, genetic conditions, or hormonal imbalances. Our fertility specialists conduct comprehensive evaluations to determine the underlying cause and recommend the most appropriate sperm retrieval technique.",
      "We offer the full range of advanced sperm retrieval techniques — PESA, TESA, TESE, and Micro-TESE. Our fertility experts recommend the most appropriate technique based on individual diagnosis and reproductive goals.",
      "If you have been diagnosed with azoospermia or are experiencing male fertility challenges, timely evaluation can make a significant difference. Our experienced andrology team provides compassionate care and evidence-based treatment to help couples move closer to parenthood.",
    ],
    symptoms: [
      "Obstructive azoospermia — blockages in the reproductive tract",
      "Non-obstructive azoospermia — reduced or impaired sperm production",
      "Previous infections or surgeries affecting fertility",
      "Genetic conditions affecting sperm production",
      "Hormonal imbalances affecting fertility",
      "Severely low sperm count or failed conventional retrieval",
    ],
    treatments: [
      { name: "PESA (Percutaneous Epididymal Sperm Aspiration)", description: "Minimally invasive needle aspiration of sperm from the epididymis — ideal for obstructive azoospermia." },
      { name: "TESA (Testicular Sperm Aspiration)", description: "Needle-based procedure to obtain sperm directly from the testicle." },
      { name: "TESE (Testicular Sperm Extraction)", description: "Minor surgical approach to retrieve sperm from testicular tissue, often used for non-obstructive azoospermia." },
      { name: "Micro-TESE", description: "Advanced microsurgical procedure that helps identify and retrieve sperm from selected areas of the testicle in difficult non-obstructive cases." },
      { name: "Coordinated IVF / ICSI", description: "Retrieved sperm used fresh or frozen with our IVF / ICSI programme for the best chance of conception." },
    ],
    whyChooseUs: [
      "Expertise in male infertility management",
      "Advanced sperm retrieval procedures under one roof",
      "Comprehensive fertility evaluation",
      "Personalised treatment plans",
      "Modern surgical facilities",
      "High standards of patient care and confidentiality",
    ],
    faqs: [
      { q: "What is surgical sperm retrieval?", a: "Surgical Sperm Retrieval (SSR) describes procedures used to collect sperm directly from the epididymis or testicles when sperm is absent in the ejaculate. Retrieved sperm can then be used in IVF or ICSI." },
      { q: "What causes azoospermia?", a: "Causes include blockages in the reproductive tract (obstructive azoospermia), reduced or impaired sperm production (non-obstructive), prior infections or surgeries, genetic conditions, and hormonal imbalances." },
      { q: "Which sperm retrieval technique is right for me?", a: "Selection depends on the cause of azoospermia, hormonal profile, scrotal examination, and prior fertility evaluation. PESA suits obstructive cases; TESA, TESE, and Micro-TESE are used in more complex or non-obstructive cases." },
      { q: "What is Micro-TESE?", a: "Micro-TESE is an advanced microsurgical procedure where an operating microscope helps identify and retrieve sperm from specific areas of the testicle — especially useful in difficult cases of non-obstructive azoospermia." },
      { q: "Will my retrieved sperm work for IVF?", a: "Yes — retrieved sperm can be used with IVF or ICSI immediately, or cryopreserved for future cycles. Our fertility experts coordinate the retrieval with your IVF programme for the best outcome." },
    ],
    icon: "M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3",
    accent: "gold",
  },
  {
    ...
    longDescription: [
      "Male infertility is a common challenge affecting many couples trying to conceive. One of the leading causes is obstructive azoospermia, a condition in which sperm production is normal, but a blockage prevents sperm from being released during ejaculation. At Joshi Andrology and Urology Centre, we offer advanced PESA Treatment in Bangalore to help men overcome infertility and achieve their dream of parenthood.",
      "As a trusted andrology hospital in Bangalore, our team specialises in modern sperm retrieval procedures and personalised fertility care. Under the guidance of experienced fertility and andrology specialists, we provide comprehensive evaluation, diagnosis, treatment, and support throughout the fertility journey.",
      "PESA (Percutaneous Epididymal Sperm Aspiration) is a minimally invasive sperm retrieval procedure used to collect sperm directly from the epididymis. The procedure is commonly recommended for men diagnosed with obstructive azoospermia, where sperm production is normal but cannot reach the semen due to a blockage. The retrieved sperm can then be used in assisted reproductive techniques such as IVF (In Vitro Fertilisation) and ICSI (Intracytoplasmic Sperm Injection), significantly improving the chances of successful conception.",
      "PESA is frequently performed before IVF or ICSI when sperm cannot be obtained naturally. During the procedure, sperm are collected using a fine needle and prepared for use in fertility treatments. The retrieved sperm may be used immediately or cryopreserved (frozen) for future IVF cycles. Our fertility specialists work closely with IVF centres to ensure seamless coordination and optimal outcomes for couples undergoing assisted reproduction.",
      "The PESA procedure success rate is generally high in men with obstructive azoospermia because sperm production within the testes remains normal. Success depends on the underlying fertility condition, duration of obstruction, sperm quality, the female partner's reproductive health, and the IVF or ICSI treatment protocol.",
      "Recovery after PESA is usually quick and uncomplicated. Most patients return to normal daily activities within a short period. Post-procedure care includes prescribed medications, avoiding strenuous physical activity for a few days, hygiene guidance, and structured follow-up — our specialists provide complete aftercare to ensure a smooth recovery and successful fertility planning.",
    ],
    symptoms: [
    ...
    treatments: [
      { name: "PESA Procedure", description: "Percutaneous needle aspiration of sperm directly from the epididymis under local or short anaesthesia." },
      { name: "Sperm Preparation for ICSI", description: "Aspirated sperm processed onsite in our andrology lab for fresh use in IVF or ICSI." },
      { name: "Sperm Cryopreservation", description: "Retrieved sperm can be frozen for use in future IVF / ICSI cycles." },
      { name: "Coordinated IVF / ICSI", description: "PESA timing matched with your partner's egg retrieval for fresh-cycle ICSI." },
      { name: "Post-Procedure Care", description: "Medication, hygiene guidance, activity advice, and structured follow-up for smooth recovery." },
    ],
    whyChooseUs: [
      ...
      "Patient-focused care and collaboration with IVF specialists",
      "High standards of safety and clinical excellence",
    ],
    faqs: [
      { q: "What is PESA?", a: "PESA (Percutaneous Epididymal Sperm Aspiration) is a minimally invasive procedure to collect sperm directly from the epididymis. It's most commonly used in obstructive azoospermia, where the sperm can then be used in IVF or ICSI." },
      { q: "Who is PESA suitable for?", a: "Men with obstructive azoospermia, previous vasectomy, congenital absence of the vas deferens, reproductive tract blockages, ejaculatory duct obstruction, or failed sperm retrieval by conventional methods." },
      { q: "Can PESA be done before IVF?", a: "Yes — PESA is frequently performed before IVF or ICSI when sperm cannot be obtained naturally. The retrieved sperm may be used immediately or cryopreserved for future cycles." },
      { q: "What is the recovery like after PESA?", a: "Recovery is quick and uncomplicated. Most patients resume normal activity within a short period. Aftercare includes prescribed medication, avoiding strenuous activity for a few days, hygiene guidance, and follow-up appointments." },
      { q: "How much does PESA cost in Bangalore?", a: "Cost depends on diagnostic evaluations, fertility requirements, lab support, and whether IVF or ICSI is planned. We provide transparent treatment planning and detailed cost information during your consultation." },
    ],
  ...
  },
  {
    ...
    longDescription: [
      "Male infertility can be a challenging condition for couples trying to conceive. Fortunately, advancements in reproductive medicine have made parenthood possible even in complex cases of male infertility. At Joshi Andrology and Urology Centre, we provide advanced TESA Treatment in Bangalore to help men with sperm production or sperm retrieval difficulties achieve their fertility goals.",
      "TESA (Testicular Sperm Aspiration) is a minimally invasive sperm retrieval procedure that allows specialists to obtain sperm directly from the testes for use in assisted reproductive techniques such as IVF and ICSI. Our experienced fertility and andrology specialists offer personalised care and advanced treatment options for patients facing male infertility.",
      "TESA is a specialised procedure used to retrieve sperm directly from the testicular tissue using a fine needle. It is commonly recommended for men with obstructive or non-obstructive azoospermia, where sperm may not be present in the ejaculate but can still be retrieved from the testes. The retrieved sperm can be used immediately during IVF treatment or preserved for future fertility procedures.",
      "The TESA procedure is performed under local anaesthesia or mild sedation to ensure patient comfort. A fine needle is inserted into the testicle, and testicular tissue containing sperm is gently aspirated. The collected sample is immediately examined by embryologists to identify healthy sperm suitable for IVF or ICSI procedures.",
      "TESA IVF Treatment is often performed in conjunction with assisted reproductive technologies such as In Vitro Fertilisation (IVF) and Intracytoplasmic Sperm Injection (ICSI). When sperm cannot be naturally ejaculated, TESA enables fertility specialists to retrieve viable sperm directly from the testes. The retrieved sperm is then used to fertilise the egg in a controlled laboratory environment, significantly improving the chances of conception.",
      "The TESA Treatment Success Rate depends on several factors, including the underlying cause of infertility, sperm quality, the female partner's reproductive health, and the IVF protocol used. Many men diagnosed with azoospermia or severe male infertility have successfully fathered biological children through TESA combined with IVF or ICSI. At Joshi Andrology and Urology Centre, we use advanced diagnostic techniques and evidence-based treatment protocols to maximise the chances of successful sperm retrieval and fertility treatment.",
    ],
    symptoms: [
      ...
      "Low sperm count with difficulty retrieving viable sperm",
      "Failed sperm retrieval through conventional methods",
    ],
    treatments: [
      { name: "TESA Procedure", description: "Fine-needle aspiration of sperm directly from testicular tissue under local anaesthesia or mild sedation." },
      { name: "Embryologist Evaluation", description: "Collected sample examined immediately by embryologists to identify healthy sperm for IVF or ICSI." },
      { name: "IVF with TESA Sperm", description: "Retrieved sperm used to fertilise the egg in a controlled IVF laboratory environment." },
      { name: "ICSI with TESA Sperm", description: "Single retrieved sperm injected directly into the egg for fertilisation in severe male-factor cases." },
      { name: "Sperm Cryopreservation", description: "Retrieved sperm preserved for future fertility procedures and IVF / ICSI cycles." },
    ],
    whyChooseUs: [
      "Experienced andrologists and fertility specialists",
      "Advanced male infertility evaluation",
      "State-of-the-art diagnostic facilities",
      "Personalised treatment plans",
      "Advanced sperm retrieval procedures",
      "Comprehensive fertility counselling",
      "Patient-focused care and support",
    ],
    faqs: [
      { q: "What is TESA?", a: "TESA (Testicular Sperm Aspiration) is a minimally invasive procedure where sperm is retrieved directly from the testicular tissue using a fine needle. It's used in azoospermia and severe male infertility." },
      { q: "Who needs TESA treatment?", a: "Men with azoospermia, blockages in the reproductive tract, prior vasectomy, ejaculatory dysfunction, severe male infertility, or failed sperm retrieval through conventional methods." },
      { q: "Is TESA painful?", a: "The procedure is performed under local anaesthesia or mild sedation, so it's well tolerated. Most patients have minimal discomfort and return to routine activity within a short period." },
      { q: "Can TESA sperm be frozen?", a: "Yes — retrieved sperm can be used immediately in an IVF or ICSI cycle, or cryopreserved for future fertility treatments." },
      { q: "What is the success rate of TESA?", a: "Success depends on the cause of infertility, sperm quality, the female partner's reproductive health, and the IVF protocol used. Many men with azoospermia have achieved biological fatherhood through TESA combined with IVF or ICSI." },
    ],
    icon: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z",
    accent: "gold",
  },
